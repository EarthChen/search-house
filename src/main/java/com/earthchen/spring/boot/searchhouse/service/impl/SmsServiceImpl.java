package com.earthchen.spring.boot.searchhouse.service.impl;
...
import com.earthchen.spring.boot.searchhouse.config.sms.SmsProperties;
...
public class SmsServiceImpl implements ISmsService, InitializingBean {
    ...
    public String getSmsCode(String telephone) {
        log.info(SMS_CODE_CONTENT_PREFIX + telephone);
